...
<body onload="lista_EmpresasCliente('','1');">
    <!--Barra de Navegacion
            ...
            <div class="tab-pane active" id="tab_consultar">
                <div class="row form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h4>Empresas Cliente Existentes</h4></div>
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input  type="text" name="buscar" id="buscar" class="form-control" onkeyup="lista_EmpresasCliente(this.value,1);" placeholder="Ingrese nombre, descripcion, dirección o reponsable" onkeypress="return validateInput(event)"  onpaste="return false"/>
                                </div>
