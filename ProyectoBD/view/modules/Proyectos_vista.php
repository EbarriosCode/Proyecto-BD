...
<body>
 	<div class="container">
 		<div class="row">
            ...
            <h2 class="text-center">Mantenimiento de Proyectos <span class="icon-sitemap"></span></h2><hr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="Proyectos_controlador.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nombre-servicio" name="nombre-servicio" class="form-control" required onkeypress="return validateInput(event)"  onpaste="return false">
                                    </div>

                                    <div class="form-group">
                                        <label for="descripcion">Descripción Servicio:</label>
                                        <input type="text" id="descripcion-servicio" name="descripcion-servicio" class="form-control" required onkeypress="return validateInput(event)"  onpaste="return false">
                                    </div>
                ...
                <div class="modal fade" id="modal-insertar">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                 <h2 class="text-center "><strong>Nuevo Proyecto</strong><span class="icon-plus"></span></h2>
                            </div>
                            <div class="modal-body">
                                <form action="Proyectos_controlador.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nombre" name="nombre" class="form-control" onblur="this.className ='form-control campo';" placeholder="Nombre del Proyecto" required onkeypress="return validateInput(event)"  onpaste="return false">
                                        <span></span>
                                    </div>

                                    <div class="form-group">
                                        <label for="descripcion">Descripción Proyecto:</label>
                                        <input type="text" id="descripcion" name="descripcion" class="form-control" onblur="this.className ='form-control campo';" placeholder="Descripción del Proyecto" required onkeypress="return validateInput(event)"  onpaste="return false">
                                        <span></span>
                                    </div>
                            </div>
                ...
                <div class="modal fade" id="modal-busqueda">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="ResultadoBusquedaProyectos_controlador.php" method="POST">
	
                                    <div class="form-group text-center">
                                        <label for="nombre">Proyecto</label>	
                                        <input type="text" id="busqueda-proyecto" name="busqueda-proyecto" class="form-control" placeholder="Ingrese id, nombre o descripción del proyecto" autofocus required onkeypress="return validateInput(event)"  onpaste="return false">
                                    </div>
        	...
        	<script>
				...
				{	
				   if (window.confirm("Esta seguro que desea eliminar este registro? ") == true)
				      {
				         window.location = "Proyectos_controlador.php?accion="+accion+"&id="+idDelete;
				      }
				}
        	</script>  
			<script>
